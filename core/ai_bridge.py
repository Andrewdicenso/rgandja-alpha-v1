...
def genera_executive_report_ia(report_analisi: list, kpi_reali: dict, resilience_score: float) -> str:
    """
    ...
    try:
        ...
        # Chiamata al modello con l'identificativo stabile supportato
